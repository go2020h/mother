        ...
        <div className="story_section mt-16">
          ...
          <div className="leftProjectDetail space-y-8">
            <div className="leftText project-content space-y-8">
              ...
              <p>
                精神的、社会的な観点での健康は自分ひとりだけではなかなか得ることが難しいです。つまり健康はあなた1人だけの問題ではないということです。充電不要であるため、24時間365日データをロストしないことで、ただの身体データだけでなく、心拍数の起伏や体温の起伏など精神データとしても現れてきます。また、エナジーが可視化され社会性を持つようになり、MOTHERでつながるコミュニティとして拡大していきたいと思っています。
              </p>
              ...
              <div className="relative">
                <h1 id="faq" className="text-3xl font-bold text-center text-white bg-black py-4 px-4 mb-8 w-screen relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw]">FAQ</h1>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <p>
                    ...
                    <br />
                    <span className="text-rose-500 font-bold">A1</span>：歩数/心拍数/消費カロリー/睡眠/体表温が計測可能です。
                  </p>
                </div>
