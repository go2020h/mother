            ...
            <div className="lyt">
              <div className="logo relative w-[240px] h-[73px] mx-auto mb-8">
                <div className="in">
                  <h1>
                    <img
                      src="https://cdn.shopify.com/s/files/1/0611/4476/0578/files/logo_mother.svg?v=1638851245"
                      alt="MOTHER BRACELET"
              ...
              <div className="visual relative h-[300px] md:h-[430px]">
                <div className="image relative w-full h-full">
                  <img
                    src="https://cdn.shopify.com/s/files/1/0611/4476/0578/files/top_image_watch.png?v=1638413858"
                    alt=""
              ...
              <div className="text relative text-center">
                <p className="text-3xl font-bold mb-8">
                  Makuakeで5600万円達成の健康デバイス<br />
                  ついにレンタル開始。
                </p>
                <div className="pushbutton-wp mt-8 flex justify-center pb-16">
                  <a href="/collections" className="inline-block">
                    <div className="pushbutton px-12 py-4 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors text-lg font-bold">
                      製品一覧はこちら
                    </div>
                  </a>
                </div>
            ...
            <div className="leftProjectDetail space-y-8">
              <div className="leftText project-content space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p>サービスを提供する中で、"充電のために手首から取り外さなければならない"という課題が、<strong>ダウンタイム（データが取れない時間)</strong>を生み出し、的確なアドバイスを行う上でネックになっていました。それに加え、"充電のために一度、手首から外す"という行為そのものが、活動量計の継続利用を妨げていたのです。</p>
                </div>

                <div className="relative">
                  <h1 className="text-3xl font-bold text-center text-white bg-black py-4 px-4 mb-8 w-screen relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw]">
                    充電により 貴重なデータを失っている
                  </h1>
                </div>
                ...
                <p>しかし、既存の活動量計は<strong>充電のために、しばしば外さなければならないという面倒な問題</strong>がありました。充電のタイミングでダウンタイムが発生し、データをロストするため、複数のデバイスを使用しています。<br />
                ...
                <p>実は医療の分野では、24時間365日の連続データを取得できることがすごく期待されています。例えば、医療の現場では、薬の副作用の評価のためモニタリングが必要ですが、トラッカーが充電のために外されていると、空白の時間が生まれデータが不連続となります。この間に何が起こったか非常に問題になります。<strong>24時間365日モニタリングできる</strong>ことにより得られるメリットというのは計り知れないものがあります。MOTHER Braceletは医療分野においても大きな可能性を秘めています。</p>
                ...
                <p><strong>「充電のために身体から取り外さなければならない」</strong>という課題を克服したMOTHER Bracelet。</p>
                ...
                <p>自分のカラダをモニタリングするということは、自分の身体の仕組みを知るということです。<strong>体の仕組みを知ることで、無意識のうちに健康な状態を作る</strong>ことができます。</p>
                ...
                <p>MOTHER Bracelet は健康状態を把握する上で重要な5つの要素「<strong>歩数・心拍・活動量、体表温、睡眠量」を24時間365日自動で計測</strong>。これら全てのデータはお手持ちのスマートフォンにある"MOTHER App "から確認できます。</p>
                <p>常時装着する事で計測条件は常に一定。データが蓄積されるほど、<strong>統計的に健康状態を把握</strong>することができ、信頼性がアップしていきます。</p>

                <p>アプリ内では、過去の自分のデータと比較し、未来の傾向を掴むことが可能です。定性的な"なんとなくの"不調や"なんとなく"の好調を定量的に捉えることで、スッキリ起きられる要因、<strong>高パフォーマンスな要因を解明</strong>していきます。</p>
                ...
                <p>MOTHER Bracelet はゼーベック効果を利用した『温度差発電技術』を搭載。<strong>外気と体表面の温度差を利用し発電</strong>、駆動するので充電するために取り外す必要はありません。</p>
                <p>エストニアの物理学者トーマス・ゼーベックによって1821年に発見された現象が、<strong>200年の研究</strong>・開発を経て、ついに実生活に導入されました。</p>
                ...
                <p>これにより、体温による永続的な電力供給、つまり<strong>「充電不要」のデバイス</strong>が誕生しました。</p>
                ...
                <p>また、<strong>バンドが交換可能</strong>であるため、プライベートやビジネス、シーンを選ばず使用できます。現在、デザイナーと協力し、腕時計をより引き立たせるバンドを開発しております。</p>
                ...
                <p>お皿洗いやお風呂の掃除はもちろん、入浴時も大丈夫な<strong>50m防水</strong>。充電不要であるため、端子を繋ぐ差し込み口を気にする必要がありません。そのため、水に濡れる心配なく使用できます。</p>
                ...
                <p>MOTHER Braceletの<strong>製造はキヤノン電子と三栄電子とともに</strong>行っております。50年以上に渡り、様々な商品の技術サポートを手掛ける三栄電子と、数々のMADE IN JAPANプロダクトを生み出してきたキヤノン電子の確かな技術力が組み合わさったことで、MOTHERの高品質での製造が確固たるものになりました。</p>
                ...
                <p>健康管理に特化するため、<strong>通知と時計の機能はOFF</strong>にしました。</p>
                ...
                <p>日々の<strong>健康に対するあらゆる活動がエナジーとして加算</strong>・蓄積されていきます。</p>
                ...
                <p className="mt-8">そのエナジーは自身がおすそ分けしたい人に別の形でプレゼントすることができます。自分の子供の笑顔に、難病を抱えるアフリカの子供達、殺処分をされてしまう動物達など、自身が健康になることで得たエナジーによって対象の方々が勝手に救われていく、そのエナジーがどのように使われているか可視化され、それを見て健康へのモチベーションが上がる。そんなポジティブな社会の実現にMOTHERはチャレンジしていきます。</p>
                ...
                <p className="font-bold"><strong>全ての人に、毎日、ほんの一瞬でも、自分の健康を振り返る時間を作って欲しい。</strong></p>

                <p>精神的、社会的な観点での健康は自分ひとりだけではなかなか得ることが難しいです。つまり健康はあなた1人だけの問題ではないということです。充電不要で24時間365日データをロストしないことで、ただの身体データだけでなく、心拍数の起伏や体温の起伏など精神データとしても現れてきます。また、エナジーが可視化され社会性を持つようになり、MOTHERでつながるコミュニティとして拡大していきたいと思っています。</p>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q1</span>：<strong>計測項目は何がありますか？</strong><br />
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q2</span>：<strong>エナジーはどうやって貯まりますか？</strong><br />
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q3</span>：<strong>バンドの交換は可能ですか？</strong><br />
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q4</span>：<strong>時計機能はありますか？</strong><br />
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q5</span>：<strong>通知機能はありますか？</strong><br />
                  ...
                  <div className="space-y-2">
                    <p>
                      <span className="text-primary font-bold">Q6</span>：<strong>MOTHERアプリが対応するOSは？</strong><br />
